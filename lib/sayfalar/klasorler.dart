...
class _KlasorlerState extends State<Klasorler> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: const Color(0xFFF5F6FA), // Açık gri arka plan
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              ...
              child: Card(
                ...
                color: klasor.klasor_id == -1 ? const Color(0xFFFFF3E0) : Colors.white,
                child: SizedBox(
                  height: 84,
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: Icon(klasor.icon, color: klasor.klasor_id == -1 ? Colors.red : Color(0xFFA5D6A7), size: 36),
                      ),
                      Expanded(
                        child: Text(
                          klasor.klasor_adi,
                          style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500, color: klasor.klasor_id == -1 ? Colors.red : Colors.black),
                          maxLines: 1,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.restaurant_menu, color: Color(0xFFA5D6A7), size: 28),
